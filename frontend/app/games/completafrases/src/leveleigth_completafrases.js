var leveleigth_completafrases = function(game){
	var leftArrow;
	var errorScreen;
	var fx;
	var sound;
...
leveleigth_completafrases.prototype = {
  	create: function(){
  		intentos = 0;
  		aciertos = 0;
		// showing level title
		...
		var gameThumb = this.game.add.sprite(0, 25, "frase8");
		...
		var gameThumb11 = this.game.add.sprite(this.game.width/2 +65, 175, "sprites8_fade");
		gameThumb11.anchor.setTo(0.5);
		gameThumb11.frame = 1;
		this.game.physics.arcade.enable(gameThumb11);
		gameThumb11.tint= 0x000000;

		var gameThumb12 = this.game.add.sprite(this.game.width/2 -85, 95, "sprites8_fade");
		gameThumb12.anchor.setTo(0.5);
		gameThumb12.frame = 2;
		this.game.physics.arcade.enable(gameThumb12);
		gameThumb12.tint= 0x000000;

		var gameThumb13 = this.game.add.sprite(this.game.width/2-110, 175, "sprites8_fade");
		gameThumb13.anchor.setTo(0.5);
		gameThumb13.frame = 3;
		this.game.physics.arcade.enable(gameThumb13);
		gameThumb13.tint= 0x000000;

		var gameThumb1 = this.game.add.sprite(posX[coord[0]], posY[coord[0]], "sprites8");
		var gameThumb2 = this.game.add.sprite(posX[coord[1]], posY[coord[1]], "sprites8");
		var gameThumb3 = this.game.add.sprite(posX[coord[2]], posY[coord[2]], "sprites8");
