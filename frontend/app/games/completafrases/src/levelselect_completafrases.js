...
var levelSelect_completafrases = function(game){
...
levelSelect_completafrases.prototype = {
  	create: function(){
  		// how many pages are needed to show all levels?
	...
	thumbClicked:function(button){
		...
		if(button.frame < 4){
			...
			if (this.game.global.level == 0) {
				...
				this.game.global.level = button.levelNumber;
				this.game.state.start("LevelEigth");				
			}
			else if (this.game.global.level == 8) {
				this.game.global.level = button.levelNumber;
				this.game.state.start("LevelNine");				
			}
			else if (this.game.global.level == 9) {
				this.game.global.level = button.levelNumber;
				this.game.state.start("LevelTen");				
			}
			else if (this.game.global.level == 10) {
				this.game.global.level = button.levelNumber;
				this.game.state.start("LevelEleven");				
			}
			else if (this.game.global.level == 11) {
				this.game.global.level = button.levelNumber;
				this.game.state.start("LevelTwelve");				
			}
			else if (this.game.global.level == 12) {
				this.game.global.level = button.levelNumber;
				this.game.state.start("LevelThirteen");				
			}
			else if (this.game.global.level == 13) {
				this.game.global.level = button.levelNumber;
				this.game.state.start("LevelFourteen");				
			}
			else if (this.game.global.level == 14) {
				this.game.global.level = button.levelNumber;
				this.game.state.start("LevelFifteen");				
			}
			else if (this.game.global.level == 15) {
				this.game.global.level = button.levelNumber;
				this.game.state.start("LevelSixteen");				
			}
			else if (this.game.global.level == 16) {
				this.game.global.level = button.levelNumber;
				this.game.state.start("LevelSeventeen");				
			}
			else if (this.game.global.level == 17) {
				this.game.global.level = button.levelNumber;
				this.game.state.start("LevelEigthteen");				
			}
			else if (this.game.global.level == 18) {
				this.game.global.level = button.levelNumber;
				this.game.state.start("LevelNineteen");				
			}
			else if (this.game.global.level == 19) {
				this.game.global.level = button.levelNumber;
				this.game.state.start("LevelTwenty");				
			}
			else if (this.game.global.level == 20) {
				this.game.global.level = button.levelNumber;
				this.game.state.start("LevelTwentyone");				
			}
			else if (this.game.global.level == 21) {
				this.game.global.level = button.levelNumber;
				this.game.state.start("LevelTwentytwo");				
			}
			else if (this.game.global.level == 22) {
				this.game.global.level = button.levelNumber;
				this.game.state.start("LevelTwentythree");				
			}
			else if (this.game.global.level == 23) {
				this.game.global.level = button.levelNumber;
				this.game.state.start("LevelTwentyfour");				
			}
			else if (this.game.global.level == 24) {
				this.game.global.level = button.levelNumber;
				this.game.state.start("LevelTwentyfive");				
			}																																																									
		}
