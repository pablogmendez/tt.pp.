var levelthirteen_completafrases = function(game){
	var leftArrow;
	var errorScreen;
	var fx;
	var sound;
...
levelthirteen_completafrases.prototype = {
  	create: function(){
  		intentos = 0;
  		aciertos = 0;
		// showing level title
		...
		var gameThumb = this.game.add.sprite(0, 25, "frase13");

		var position = 370;
		var posX = [this.game.width/2 -100, this.game.width/2 +100];
		...
		var gameThumb11 = this.game.add.sprite(this.game.width/2 -120, 190, "sprites13");
		gameThumb11.anchor.setTo(0.5);
		gameThumb11.frame = 1;
		this.game.physics.arcade.enable(gameThumb11);
		gameThumb11.tint= 0x000000;

		var gameThumb12 = this.game.add.sprite(this.game.width/2 -90, 60, "sprites13");
		gameThumb12.anchor.setTo(0.5);
		gameThumb12.frame = 2;
		this.game.physics.arcade.enable(gameThumb12);
		gameThumb12.tint= 0x000000;

		var gameThumb1 = this.game.add.sprite(posX[coord[0]], posY[coord[0]], "sprites13");
		var gameThumb2 = this.game.add.sprite(posX[coord[1]], posY[coord[1]], "sprites13");
