var leveltwentyone_completafrases = function(game){
	var leftArrow;
	var errorScreen;
	var fx;
	var sound;
...
leveltwentyone_completafrases.prototype = {
  	create: function(){
  		intentos = 0;
  		aciertos = 0;
		// showing level title
		...
		var gameThumb = this.game.add.sprite(0, 25, "frase21");
		...
		var gameThumb11 = this.game.add.sprite(this.game.width/2 -100, 205, "sprites21_fotos");
		gameThumb11.anchor.setTo(0.5);
		gameThumb11.frame = 1;
		this.game.physics.arcade.enable(gameThumb11);
		gameThumb11.tint= 0x000000;

		/*var gameThumb11 = this.game.add.sprite(this.game.width/2 -110, 185, "sprites20_fade");
		gameThumb11.anchor.setTo(0.5);
		gameThumb11.frame = 1;
		this.game.physics.arcade.enable(gameThumb11);
		gameThumb11.tint= 0x000000;*/

		var gameThumb12 = this.game.add.sprite(this.game.width/2 -100, 85, "sprites21_fotos");
		gameThumb12.anchor.setTo(0.5);
		gameThumb12.frame = 2;
		this.game.physics.arcade.enable(gameThumb12);
		gameThumb12.tint= 0x000000;

		var gameThumb13 = this.game.add.sprite(this.game.width/2, 132, "sprites21_palabras_fade");
		gameThumb13.anchor.setTo(0.5);
		gameThumb13.frame = 1;
		this.game.physics.arcade.enable(gameThumb13);
		gameThumb13.tint= 0x000000;

		var gameThumb14 = this.game.add.sprite(this.game.width/2, 275, "sprites21_palabras_fade");
		gameThumb14.anchor.setTo(0.5);
		gameThumb14.frame = 2;
		this.game.physics.arcade.enable(gameThumb14);
		gameThumb14.tint= 0x000000;

		var gameThumb1 = this.game.add.sprite(posX[coord[0]], posY[coord[0]], "sprites21_fotos");
		var gameThumb2 = this.game.add.sprite(posX[coord[1]], posY[coord[1]], "sprites21_fotos");
		var gameThumb3 = this.game.add.sprite(posX[coord[2]], posY[coord[2]], "sprites21_palabras");
		var gameThumb4 = this.game.add.sprite(posX[coord[3]], posY[coord[3]], "sprites21_palabras");
