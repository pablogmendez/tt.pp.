var levelfour_asociaformas = function(game){
	var leftArrow;
	var errorScreen;
	var fx;
	var sound;
...
levelfour_asociaformas.prototype = {
  	create: function(){
  		intentos = 0;
  		aciertos = 0;
		// showing level title
		...
		var shapesToShow=[];
		for(var i = 0; i < 4; ++i) {
			shapesToShow.push(Math.floor((Math.random() * 10)));
		}
		...
		var gameThumb20 = this.game.add.sprite(posX[coord[0]], posY[coord[0]], "objetos_frames");
		var gameThumb21 = this.game.add.sprite(posX[coord[1]], posY[coord[1]], "objetos_frames");
		var gameThumb22 = this.game.add.sprite(posX[coord[2]], posY[coord[2]], "objetos_frames");
		var gameThumb23 = this.game.add.sprite(posX[coord[3]], posY[coord[3]], "objetos_frames");

		if(this.game.global.level == 10) {
			var gameThumb = this.game.add.sprite(posX[coord[0]] - 50, posY[coord[0]], "objetos_fade");
			var gameThumb2 = this.game.add.sprite(posX[coord[1]] - 50, posY[coord[1]], "objetos_fade");
			var gameThumb4 = this.game.add.sprite(posX[coord[2]] - 50, posY[coord[2]], "objetos_fade");
			var gameThumb6 = this.game.add.sprite(posX[coord[3]] - 50, posY[coord[3]], "objetos_fade");
		}
		else if (this.game.global.level == 11) {
			var gameThumb = this.game.add.sprite(posX[coord[0]] - 50, posY[coord[0]], "objetos_black");
			var gameThumb2 = this.game.add.sprite(posX[coord[1]] - 50, posY[coord[1]], "objetos_black");
			var gameThumb4 = this.game.add.sprite(posX[coord[2]] - 50, posY[coord[2]], "objetos_black");
			var gameThumb6 = this.game.add.sprite(posX[coord[3]] - 50, posY[coord[3]], "objetos_black");
		}
		else if (this.game.global.level == 12) {
			var gameThumb = this.game.add.sprite(posX[coord[0]] - 50, posY[coord[0]], "objetos_withe");
			var gameThumb4 = this.game.add.sprite(posX[coord[2]] - 50, posY[coord[2]], "objetos_withe");
			var gameThumb2 = this.game.add.sprite(posX[coord[1]] - 50, posY[coord[1]], "objetos_withe");
			var gameThumb6 = this.game.add.sprite(posX[coord[3]] - 50, posY[coord[3]], "objetos_withe");
		}


		var gameThumb10 = this.game.add.sprite(50, posY[coord[0]], "objetos_norm");
		var gameThumb11 = this.game.add.sprite(50, posY[coord[1]], "objetos_norm");
		var gameThumb12 = this.game.add.sprite(50, posY[coord[2]], "objetos_norm");
		var gameThumb13 = this.game.add.sprite(50, posY[coord[3]], "objetos_norm");
		...
		fx.addMarker('consigna', 12.1, 3.5);
		fx.play('consigna');

		// Cargo los audios de las respuestas
		fx2 = this.game.add.audio('respestas_objetos');
    	fx2.allowMultiple = true;
		fx2.addMarker('heladera', 0, 2.5);
		fx2.addMarker('avion', 2.6, 2.3);
		fx2.addMarker('barco', 5.0, 2.5);
		fx2.addMarker('libros', 7.6, 2.5);
		fx2.addMarker('microfono', 10.2, 3.0);
		fx2.addMarker('pinceles', 13.3, 3.0);
		fx2.addMarker('fuego', 16.4, 2.5);
		fx2.addMarker('cohete', 19.0, 2.0);
		fx2.addMarker('invierno', 21.1, 3.0);
		fx2.addMarker('silla', 24.2, 2.8);
		
		shapeSounds=['heladera', 'avion', 'barco', 'libros',
		'microfono', 'pinceles', 'fuego', 'cohete',
		'invierno', 'silla',];
	},
