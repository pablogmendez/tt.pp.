...
var levelSelect_asociaformas = function(game){
...
levelSelect_asociaformas.prototype = {
  	create: function(){
  		// how many pages are needed to show all levels?
	...
	thumbClicked:function(button){
		...
		if(button.frame < 4){
			if (this.game.global.level >= 0 && this.game.global.level <= 2) {
console.log("estoy en 1");
				this.game.global.level = button.levelNumber;
				this.game.state.start("LevelOne");				
			}
			else if (this.game.global.level >= 3 && this.game.global.level <= 5) {
				console.log("estoy en 2");
				this.game.global.level = button.levelNumber;
				console.log(this.game.global.level);
				this.game.state.start("LevelTwo");				
			}
			else if (this.game.global.level >= 6 && this.game.global.level <= 8) {
console.log("estoy en 3");
				this.game.global.level = button.levelNumber;
				this.game.state.start("LevelThree");				
			}
			else if (this.game.global.level >= 9 && this.game.global.level <= 11) {
console.log("estoy en 4");
				this.game.global.level = button.levelNumber;
				this.game.state.start("LevelFour");				
			}
			else if (this.game.global.level >= 12 && this.game.global.level <= 14) {
