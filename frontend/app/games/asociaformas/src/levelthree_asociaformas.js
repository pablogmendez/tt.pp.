var levelthree_asociaformas = function(game){
	var leftArrow;
	var errorScreen;
	var fx;
	var sound;
...
levelthree_asociaformas.prototype = {
  	create: function(){
  		intentos = 0;
  		aciertos = 0;
		// showing level title
		...
		var gameThumb20 = this.game.add.sprite(posX[coord[0]], posY[coord[0]], "animales_frames");
		var gameThumb21 = this.game.add.sprite(posX[coord[1]], posY[coord[1]], "animales_frames");
		var gameThumb22 = this.game.add.sprite(posX[coord[2]], posY[coord[2]], "animales_frames");
		var gameThumb23 = this.game.add.sprite(posX[coord[3]], posY[coord[3]], "animales_frames");

		if(this.game.global.level == 7) {
			var gameThumb = this.game.add.sprite(posX[coord[0]] - 50, posY[coord[0]], "animales_fade");
			var gameThumb2 = this.game.add.sprite(posX[coord[1]] - 50, posY[coord[1]], "animales_fade");
			var gameThumb4 = this.game.add.sprite(posX[coord[2]] - 50, posY[coord[2]], "animales_fade");
			var gameThumb6 = this.game.add.sprite(posX[coord[3]] - 50, posY[coord[3]], "animales_fade");
		}
		else if (this.game.global.level == 8) {
			var gameThumb = this.game.add.sprite(posX[coord[0]] - 50, posY[coord[0]], "animales_black");
			var gameThumb2 = this.game.add.sprite(posX[coord[1]] - 50, posY[coord[1]], "animales_black");
			var gameThumb4 = this.game.add.sprite(posX[coord[2]] - 50, posY[coord[2]], "animales_black");
			var gameThumb6 = this.game.add.sprite(posX[coord[3]] - 50, posY[coord[3]], "animales_black");
		}
		else if (this.game.global.level == 9) {
			var gameThumb = this.game.add.sprite(posX[coord[0]] - 50, posY[coord[0]], "animales_withe");
			var gameThumb4 = this.game.add.sprite(posX[coord[2]] - 50, posY[coord[2]], "animales_withe");
			var gameThumb2 = this.game.add.sprite(posX[coord[1]] - 50, posY[coord[1]], "animales_withe");
			var gameThumb6 = this.game.add.sprite(posX[coord[3]] - 50, posY[coord[3]], "animales_withe");
		}


		var gameThumb10 = this.game.add.sprite(50, posY[coord[0]], "animales_norm");
		var gameThumb11 = this.game.add.sprite(50, posY[coord[1]], "animales_norm");
		var gameThumb12 = this.game.add.sprite(50, posY[coord[2]], "animales_norm");
		var gameThumb13 = this.game.add.sprite(50, posY[coord[3]], "animales_norm");
		...
		fx.addMarker('consigna', 8.1, 4.0);
		fx.play('consigna');

		// Cargo los audios de las respuestas
		fx2 = this.game.add.audio('respestas_animales');
    	fx2.allowMultiple = true;
		fx2.addMarker('mono', 0, 2.3);
		fx2.addMarker('camello', 2.3, 2.0);
		fx2.addMarker('perro', 4.4, 2.5);
		fx2.addMarker('vaca', 7.0, 1.5);
		fx2.addMarker('gato', 8.6, 2.2);
		fx2.addMarker('cocodrilo', 10.9, 3.0);
		fx2.addMarker('raton', 14.0, 2.0);
		fx2.addMarker('leon', 16.1, 2.0);
		fx2.addMarker('oveja', 18.2, 3.0);
		fx2.addMarker('conejo', 21.3, 2.8);
		
		shapeSounds=['mono', 'camello', 'perro', 'vaca',
		'gato', 'cocodrilo', 'raton', 'leon',
		'oveja', 'conejo',];
	},
