var levelfive_asociaformas = function(game){
	var leftArrow;
	var errorScreen;
	var fx;
	var sound;
...
levelfive_asociaformas.prototype = {
  	create: function(){
  		intentos = 0;
  		aciertos = 0;
		// showing level title
		...
		var gameThumb20 = this.game.add.sprite(posX[coord[0]], posY[coord[0]], "objetos2_frames");
		var gameThumb21 = this.game.add.sprite(posX[coord[1]], posY[coord[1]], "objetos2_frames");
		var gameThumb22 = this.game.add.sprite(posX[coord[2]], posY[coord[2]], "objetos2_frames");
		var gameThumb23 = this.game.add.sprite(posX[coord[3]], posY[coord[3]], "objetos2_frames");

		if(this.game.global.level == 13) {
			var gameThumb = this.game.add.sprite(posX[coord[0]] - 50, posY[coord[0]], "objetos2_fade");
			var gameThumb2 = this.game.add.sprite(posX[coord[1]] - 50, posY[coord[1]], "objetos2_fade");
			var gameThumb4 = this.game.add.sprite(posX[coord[2]] - 50, posY[coord[2]], "objetos2_fade");
			var gameThumb6 = this.game.add.sprite(posX[coord[3]] - 50, posY[coord[3]], "objetos2_fade");
		}
		else if (this.game.global.level == 14) {
			var gameThumb = this.game.add.sprite(posX[coord[0]] - 50, posY[coord[0]], "objetos2_black");
			var gameThumb2 = this.game.add.sprite(posX[coord[1]] - 50, posY[coord[1]], "objetos2_black");
			var gameThumb4 = this.game.add.sprite(posX[coord[2]] - 50, posY[coord[2]], "objetos2_black");
			var gameThumb6 = this.game.add.sprite(posX[coord[3]] - 50, posY[coord[3]], "objetos2_black");
		}
		else if (this.game.global.level == 15) {
			var gameThumb = this.game.add.sprite(posX[coord[0]] - 50, posY[coord[0]], "objetos2_withe");
			var gameThumb4 = this.game.add.sprite(posX[coord[2]] - 50, posY[coord[2]], "objetos2_withe");
			var gameThumb2 = this.game.add.sprite(posX[coord[1]] - 50, posY[coord[1]], "objetos2_withe");
			var gameThumb6 = this.game.add.sprite(posX[coord[3]] - 50, posY[coord[3]], "objetos2_withe");
		}


		var gameThumb10 = this.game.add.sprite(50, posY[coord[0]], "objetos2_norm");
		var gameThumb11 = this.game.add.sprite(50, posY[coord[1]], "objetos2_norm");
		var gameThumb12 = this.game.add.sprite(50, posY[coord[2]], "objetos2_norm");
		var gameThumb13 = this.game.add.sprite(50, posY[coord[3]], "objetos2_norm");
		...
		fx.addMarker('consigna', 15.7, 4.0);
		fx.play('consigna');

		// Cargo los audios de las respuestas
		fx2 = this.game.add.audio('respestas_objetos2');
    	fx2.allowMultiple = true;
		fx2.addMarker('anteojos', 0, 3.0);
		fx2.addMarker('cubiertos', 3.1, 3.0);
		fx2.addMarker('almohada', 6.2, 3.0);
		fx2.addMarker('hoja', 9.3, 3.0);
		fx2.addMarker('pelota', 12.4, 2.0);
		fx2.addMarker('flecha', 14.5, 3.0);
		fx2.addMarker('dientes', 17.6, 2.5);
		fx2.addMarker('lapiz', 20.2, 3.0);
		fx2.addMarker('peine', 23.3, 2.5);
		fx2.addMarker('medias', 25.9, 2.8);

		shapeSounds=['anteojos', 'cubiertos', 'almohada', 'hoja',
		'pelota', 'flecha', 'dientes',
		'lapiz', 'peine', 'medias',];
	},
