var levelone_asociaformas = function(game){
	var leftArrow;
	var errorScreen;
	var fx;
	var sound;
...
levelone_asociaformas.prototype = {
  	create: function(){
  		intentos = 0;
  		aciertos = 0;
		// showing level title
		...
		var gameThumb20 = this.game.add.sprite(posX[coord[0]], posY[coord[0]], "profesiones_frames");
		var gameThumb21 = this.game.add.sprite(posX[coord[1]], posY[coord[1]], "profesiones_frames");
		var gameThumb22 = this.game.add.sprite(posX[coord[2]], posY[coord[2]], "profesiones_frames");
		var gameThumb23 = this.game.add.sprite(posX[coord[3]], posY[coord[3]], "profesiones_frames");

		if(this.game.global.level == 1) {
			var gameThumb = this.game.add.sprite(posX[coord[0]] - 50, posY[coord[0]], "profesiones_fade");
			var gameThumb2 = this.game.add.sprite(posX[coord[1]] - 50, posY[coord[1]], "profesiones_fade");
			var gameThumb4 = this.game.add.sprite(posX[coord[2]] - 50, posY[coord[2]], "profesiones_fade");
			var gameThumb6 = this.game.add.sprite(posX[coord[3]] - 50, posY[coord[3]], "profesiones_fade");
		}
		else if (this.game.global.level == 2) {
			var gameThumb = this.game.add.sprite(posX[coord[0]] - 50, posY[coord[0]], "profesiones_black");
			var gameThumb2 = this.game.add.sprite(posX[coord[1]] - 50, posY[coord[1]], "profesiones_black");
			var gameThumb4 = this.game.add.sprite(posX[coord[2]] - 50, posY[coord[2]], "profesiones_black");
			var gameThumb6 = this.game.add.sprite(posX[coord[3]] - 50, posY[coord[3]], "profesiones_black");
		}
		else if (this.game.global.level == 3) {
			var gameThumb = this.game.add.sprite(posX[coord[0]] - 50, posY[coord[0]], "profesiones_withe");
			var gameThumb4 = this.game.add.sprite(posX[coord[2]] - 50, posY[coord[2]], "profesiones_withe");
			var gameThumb2 = this.game.add.sprite(posX[coord[1]] - 50, posY[coord[1]], "profesiones_withe");
			var gameThumb6 = this.game.add.sprite(posX[coord[3]] - 50, posY[coord[3]], "profesiones_withe");
		}


		var gameThumb10 = this.game.add.sprite(50, posY[coord[0]], "profesiones_norm");
		var gameThumb11 = this.game.add.sprite(50, posY[coord[1]], "profesiones_norm");
		var gameThumb12 = this.game.add.sprite(50, posY[coord[2]], "profesiones_norm");
		var gameThumb13 = this.game.add.sprite(50, posY[coord[3]], "profesiones_norm");
		...
		fx2 = this.game.add.audio('respestas_profesiones');
    	fx2.allowMultiple = true;
		fx2.addMarker('bombero', 0, 4.0);
		fx2.addMarker('policia', 4, 4.5);
		fx2.addMarker('cientifico', 8.6, 4.0);
		fx2.addMarker('marinero', 12.7, 4.0);
		fx2.addMarker('mago', 16.8, 3.0);
		fx2.addMarker('astronauta', 19.8, 3.0);
		fx2.addMarker('medico', 23.0, 4.0);
		fx2.addMarker('cartero', 26.8, 3.0);
		fx2.addMarker('mecanico', 30.0, 3.3);
		fx2.addMarker('granjero', 33.4, 2.8);
		fx2.addMarker('jugador', 36.3, 2.5);
		fx2.addMarker('sacerdote', 38.7, 4.0);

		shapeSounds=['policia', 'sacerdote', 'bombero', 'astronauta',
		'medico', 'cartero', 'cientifico', 'mecanico',
		'marinero', 'granjero', 'jugador', 'mago',];
	},
