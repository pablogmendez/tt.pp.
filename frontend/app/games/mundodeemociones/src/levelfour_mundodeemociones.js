var levelfour_mundodeemociones = function(game){
	var leftArrow;
	var errorScreen;
	var fx;
	var sound;
...
levelfour_mundodeemociones.prototype = {
  	create: function(){
  		intentos = 0;
  		aciertos = 0;
		// showing level title
		...
		var textList = ["Arma una cara de alegria", "Arma una cara de sorpresa", "Arma una cara de verguenza", "Arma una cara de tristeza", "Arma una cara de llanto", "Arma una cara de enojo"];

		var consigna = this.game.add.text(this.game.width/2 - 100,390,textList[requestedShape],style);
