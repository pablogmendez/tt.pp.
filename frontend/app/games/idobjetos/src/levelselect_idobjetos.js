...
var levelSelect_idobjetos = function(game){
...
levelSelect_idobjetos.prototype = {
  	create: function(){
		// showing level title
		var style = {
			font: "16px Arial",
		...
		console.log(this.game.global.stats);
  		...
  		console.log("sssssssssssssss: " +this.game.global.starsArray.length );
  		console.log(this.game.global.starsArray);
  		var endGame = true;
