var leveltwo_mueveimagenes = function(game){
	var leftArrow;
	var errorScreen;
	var fx;
	var sound;
...
leveltwo_mueveimagenes.prototype = {
  	create: function(){
  		intentos = 0;
  		fase = 1;
		// showing level title
		...
		if(this.game.global.level == 5) {
			gameThumb1 = this.game.add.sprite(0, 50, "elefante");
			...
			boton2 = this.game.add.button(this.game.width/2 - 120, 320, "boton6", this.levelFailed, this);
			boton1 = this.game.add.button(this.game.width/2 - 120, 370, "boton5", this.destroySprite, this);
			boton4 = this.game.add.button(this.game.width/2 + 30, 320, "boton8", this.levelFailed, this);
			boton3 = this.game.add.button(this.game.width/2 + 30, 370, "boton7", this.levelFailed, this);
		}
		else if (this.game.global.level == 6) {
			gameThumb1 = this.game.add.sprite(0, 50, "ciervo");
			this.game.physics.enable(gameThumb1, Phaser.Physics.ARCADE);
	    	gameThumb1.body.velocity.x=70;
	    	gameThumb1.checkWorldBounds = true;
	    	gameThumb1.events.onOutOfBounds.add(this.levelSelect, this);
			this.game.add.button(this.game.width/2 - 120, 370, "boton6", this.destroySprite, this);
			this.game.add.button(this.game.width/2 - 120, 320, "boton5", this.levelFailed, this);
			this.game.add.button(this.game.width/2 + 30, 320, "boton8", this.levelFailed, this);
			this.game.add.button(this.game.width/2 + 30, 370, "boton7", this.levelFailed, this);
		}
		else if (this.game.global.level == 7) {
			gameThumb1 = this.game.add.sprite(0, 50, "leon");
			this.game.physics.enable(gameThumb1, Phaser.Physics.ARCADE);
	    	gameThumb1.body.velocity.x=90;
	    	gameThumb1.checkWorldBounds = true;
	    	gameThumb1.events.onOutOfBounds.add(this.levelSelect, this);
			this.game.add.button(this.game.width/2 - 120, 320, "boton6", this.levelFailed, this);
			this.game.add.button(this.game.width/2 - 120, 370, "boton5", this.levelFailed, this);
			this.game.add.button(this.game.width/2 + 30, 320, "boton8", this.levelFailed, this);
			this.game.add.button(this.game.width/2 + 30, 370, "boton7", this.destroySprite, this);
		}
		else if (this.game.global.level == 8) {
			gameThumb1 = this.game.add.sprite(0, 50, "pajaro");
			this.game.physics.enable(gameThumb1, Phaser.Physics.ARCADE);
			...
			this.game.add.button(this.game.width/2 - 120, 320, "boton6", this.levelFailed, this);
			this.game.add.button(this.game.width/2 - 120, 370, "boton5", this.levelFailed, this);
			this.game.add.button(this.game.width/2 + 30, 320, "boton8", this.destroySprite, this);
			this.game.add.button(this.game.width/2 + 30, 370, "boton7", this.levelFailed, this);
		}
	},
...
/*		errorScreen = this.game.add.sprite(0,0,"whitescreen");
	...
	passPhase: function() {
		if(fase == 2 && this.game.global.level == 5) {
			gameThumb1 = this.game.add.sprite(0, 50, "ciervo");
			this.game.physics.enable(gameThumb1, Phaser.Physics.ARCADE);
	    	gameThumb1.body.velocity.x=50;
	    	gameThumb1.checkWorldBounds = true;
	    	gameThumb1.events.onOutOfBounds.add(this.levelSelect, this);
			this.game.add.button(this.game.width/2 - 120, 320, "boton6", this.levelFinished, this);
			this.game.add.button(this.game.width/2 - 120, 370, "boton5", this.levelFailed, this);
			this.game.add.button(this.game.width/2 + 30, 320, "boton7", this.levelFailed, this);
			this.game.add.button(this.game.width/2 + 30, 370, "boton8", this.levelFailed, this);		
		}
		else if(fase == 2 && this.game.global.level == 6) {
			gameThumb1 = this.game.add.sprite(0, 50, "leon");
			this.game.physics.enable(gameThumb1, Phaser.Physics.ARCADE);
	    	gameThumb1.body.velocity.x=70;
	    	gameThumb1.checkWorldBounds = true;
			...
			this.game.add.button(this.game.width/2 - 120, 320, "boton6", this.levelFailed, this);
			this.game.add.button(this.game.width/2 - 120, 370, "boton5", this.levelFailed, this);
			this.game.add.button(this.game.width/2 + 30, 320, "boton7", this.levelFinished, this);
			this.game.add.button(this.game.width/2 + 30, 370, "boton8", this.levelFailed, this);		
		}
		else if(fase == 2 && this.game.global.level == 7) {
			gameThumb1 = this.game.add.sprite(0, 50, "pajaro");
			this.game.physics.enable(gameThumb1, Phaser.Physics.ARCADE);
	    	gameThumb1.body.velocity.x=90;
	    	gameThumb1.checkWorldBounds = true;
			...
			this.game.add.button(this.game.width/2 - 120, 370, "boton5", this.levelFailed, this);
			this.game.add.button(this.game.width/2 + 30, 320, "boton7", this.levelFailed, this);
			this.game.add.button(this.game.width/2 + 30, 370, "boton8", this.levelFinished, this);		
		}
		else if(fase == 2 && this.game.global.level == 8) {
			gameThumb1 = this.game.add.sprite(0, 50, "elefante");
			this.game.physics.enable(gameThumb1, Phaser.Physics.ARCADE);
	    	gameThumb1.body.velocity.x=110;
	    	gameThumb1.checkWorldBounds = true;
	    	gameThumb1.events.onOutOfBounds.add(this.levelSelect, this);
			this.game.add.button(this.game.width/2 - 120, 320, "boton6", this.levelFailed, this);
			this.game.add.button(this.game.width/2 - 120, 370, "boton5", this.levelFinished, this);
			this.game.add.button(this.game.width/2 + 30, 320, "boton7", this.levelFailed, this);
			this.game.add.button(this.game.width/2 + 30, 370, "boton8", this.levelFailed, this);		
		}
	},
