var levelfive_colorama = function(game){
	var leftArrow;
	var errorScreen;
	var fx;
	var sound;
...
levelfive_colorama.prototype = {
  	create: function(){
		...
		var gameThumb = this.game.add.sprite(posX[coord[0]], posY[coord[0]], "formas_fade");
		var gameThumb2 = this.game.add.sprite(posX[coord[1]], posY[coord[1]], "formas_fade");
		var gameThumb4 = this.game.add.sprite(posX[coord[2]], posY[coord[2]], "formas_fade");
		var gameThumb6 = this.game.add.sprite(posX[coord[3]], posY[coord[3]], "formas_fade");
		var gameThumb8 = this.game.add.sprite(posX[coord[4]], posY[coord[4]], "formas_fade");
		var gameThumb10 = this.game.add.sprite(posX[coord[5]], posY[coord[5]], "formas_fade");
		...
		for(var j = 0; j < shapesToShow.length; j++) {
			if(shapesToShow[i] == shapesToShow[j]) {
				switch(j) {
					case 0:
